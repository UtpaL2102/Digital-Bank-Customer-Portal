      ...
      <div className="p-4 md:p-8">
        ...
        <div className="mb-6 border-b border-gray-200">
          ...
          >
            <a
              href="#"
              className="whitespace-nowrap py-2 px-1 border-b-2 border-[#001BB7] font-bold text-gray-900 text-sm"
            >
              Employees
            </a>
            <a
              href="#"
              className="whitespace-nowrap py-2 px-1 border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 text-sm"
            >
              Branches
            </a>
            <a
              ...
              <tbody>
                <tr className="border-b border-gray-200 bg-white">
                  ...
                  <td className="py-4 px-4 text-sm">
                    <a className="text-gray-600 hover:text-[#0046FF] hover:underline" href="#">Edit</a>
                    <span className="text-gray-300 mx-1">•</span>
                    <a className="text-gray-600 hover:text-[#0046FF] hover:underline" href="#">Remove</a>
                  </td>
                </tr>
